...
RUN apk add git && \
    ...
    VITE_SENTRY_ENV=${SENTRY_ENV} SENTRY_ORG=${SENTRY_ORG} SENTRY_PROJECT=${SENTRY_PROJECT} \
    SENTRY_AUTH_TOKEN=${SENTRY_AUTH_TOKEN} VITE_SENTRY_RELEASE=$(git rev-parse --short HEAD) \
