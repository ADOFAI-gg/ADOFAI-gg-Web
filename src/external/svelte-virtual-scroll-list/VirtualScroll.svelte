<script>
  ...
  export function getOffset() {
    if (pageMode) {
      return document.querySelector('.simplebar-content-wrapper')[directionKey];
    } else {
  ...
  export function getClientSize() {
    ...
    if (pageMode) {
      return document.querySelector('.simplebar-content-wrapper')[key];
    } else {
  ...
  export function scrollToOffset(offset) {
    if (pageMode) {
      document.querySelector('.simplebar-content-wrapper')[directionKey] = offset;
    } else if (root) {
  ...
  onMount(() => {
    ...
    if (pageMode) {
      ...
      document.querySelector('.simplebar-content-wrapper').addEventListener('scroll', onScroll, {
        passive: false
      });
    }
  });
  ...
  onDestroy(() => {
    virtual.destroy();
    if (pageMode) {
      document.querySelector('.simplebar-content-wrapper').removeEventListener('scroll', onScroll);
    }
  });
