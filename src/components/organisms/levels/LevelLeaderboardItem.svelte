<script lang="ts">
  ...
  import TopPlayDetailPair from '@/components/molecules/home/TopPlayDetailPair.svelte';

  import LeaderboardStatItem from '@/components/molecules/LeaderboardStatItem.svelte';
